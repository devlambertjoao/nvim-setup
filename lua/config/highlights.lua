...
hi('StatusLineGitSignsAdd', { fg = palette.base0B, bg = palette.baseNN, attr = nil, sp = nil })
hi('StatusLineGitSignsChange', { fg = palette.base0E, bg = palette.baseNN, attr = nil, sp = nil })
hi('StatusLineGitSignsDelete', { fg = palette.base08, bg = palette.baseNN, attr = nil, sp = nil })
hi('StatusLineGitSignsOnBranch', { fg = palette.base05, bg = palette.baseNN, attr = 'bold', sp = nil })
...
hi('StatusLineFileinfo', { fg = palette.base05, bg = palette.baseNN, attr = nil, sp = nil })
...
-- UI
hi('ColorColumn', { fg = nil, bg = palette.baseNN, attr = nil, sp = nil })
hi('Conceal', { fg = palette.base0D, bg = nil, attr = nil, sp = nil })
hi('Cursor', { fg = palette.base00, bg = palette.base05, attr = nil, sp = nil })
hi('CursorColumn', { fg = nil, bg = palette.baseNN, attr = nil, sp = nil })
hi('CursorIM', { fg = palette.base00, bg = palette.base05, attr = nil, sp = nil })
hi('CursorLine', { fg = nil, bg = palette.baseNN, attr = nil, sp = nil })
hi('CursorLineFold', { fg = palette.base0C, bg = palette.baseNN, attr = nil, sp = nil })
hi('CursorLineNr', { fg = palette.base04, bg = palette.baseNN, attr = nil, sp = nil })
hi('CursorLineSign', { fg = palette.base03, bg = palette.baseNN, attr = nil, sp = nil })
hi('DiffAdd', { fg = palette.base0B, bg = palette.baseNN, attr = nil, sp = nil })
hi('DiffChange', { fg = palette.base0E, bg = palette.baseNN, attr = nil, sp = nil })
hi('DiffDelete', { fg = palette.base08, bg = palette.baseNN, attr = nil, sp = nil })
hi('DiffText', { fg = palette.base0D, bg = palette.baseNN, attr = nil, sp = nil })
hi('Directory', { fg = palette.base0D, bg = nil, attr = nil, sp = nil })
hi('EndOfBuffer', { fg = palette.base03, bg = nil, attr = nil, sp = nil })
hi('ErrorMsg', { fg = palette.base08, bg = palette.baseNN, attr = nil, sp = nil })
hi('FoldColumn', { fg = palette.base0C, bg = palette.baseNN, attr = nil, sp = nil })
hi('Folded', { fg = palette.base03, bg = palette.baseNN, attr = nil, sp = nil })
...
hi('LineNr', { fg = palette.base03, bg = palette.baseNN, attr = nil, sp = nil })
hi('LineNrAbove', { fg = palette.base03, bg = palette.baseNN, attr = nil, sp = nil })
hi('LineNrBelow', { fg = palette.base03, bg = palette.baseNN, attr = nil, sp = nil })
...
hi('MsgArea', { fg = palette.base05, bg = palette.baseNN, attr = nil, sp = nil })
hi('MsgSeparator', { fg = palette.base04, bg = palette.base02, attr = nil, sp = nil })
hi('NonText', { fg = palette.base03, bg = nil, attr = nil, sp = nil })
hi('Normal', { fg = palette.base05, bg = palette.baseNN, attr = nil, sp = nil })
hi('NormalFloat', { fg = palette.base05, bg = palette.baseNN, attr = nil, sp = nil })
hi('NormalNC', { fg = palette.base05, bg = palette.baseNN, attr = nil, sp = nil })
hi('PMenu', { fg = palette.base05, bg = palette.baseNN, attr = nil, sp = nil })
...
hi('QuickFixLine', { fg = nil, bg = palette.baseNN, attr = nil, sp = nil })
hi('Search', { fg = palette.base01, bg = palette.base0A, attr = nil, sp = nil })
hi('SignColumn', { fg = palette.base03, bg = palette.baseNN, attr = nil, sp = nil })
...
hi('StatusLineNC', { fg = palette.base03, bg = palette.baseNN, attr = nil, sp = nil })
hi('Substitute', { fg = palette.base01, bg = palette.base0A, attr = nil, sp = nil })
hi('TabLine', { fg = palette.base03, bg = palette.baseNN, attr = nil, sp = nil })
hi('TabLineFill', { fg = palette.base03, bg = palette.baseNN, attr = nil, sp = nil })
hi('TabLineSel', { fg = palette.base0B, bg = palette.baseNN, attr = nil, sp = nil })
...
hi('WinBarNC', { fg = palette.base03, bg = palette.baseNN, attr = nil, sp = nil })
...
hi('Todo', { fg = palette.base0A, bg = palette.baseNN, attr = nil, sp = nil })
...
hi('DiagnosticFloatingError', { fg = palette.base08, bg = palette.baseNN, attr = nil, sp = nil })
hi('DiagnosticFloatingHint', { fg = palette.base0D, bg = palette.baseNN, attr = nil, sp = nil })
hi('DiagnosticFloatingInfo', { fg = palette.base0C, bg = palette.baseNN, attr = nil, sp = nil })
hi('DiagnosticFloatingOk', { fg = palette.base0B, bg = palette.baseNN, attr = nil, sp = nil })
hi('DiagnosticFloatingWarn', { fg = palette.base0E, bg = palette.baseNN, attr = nil, sp = nil })
...
hi('CmpItemKind', { fg = palette.base0F, bg = palette.baseNN, attr = nil, sp = nil })
hi('CmpItemMenu', { fg = palette.base05, bg = palette.baseNN, attr = nil, sp = nil })
...
-- Git Signs
hi('GitSignsAdd', { fg = palette.base0B, bg = palette.baseNN, attr = nil, sp = nil })
hi('GitSignsAddLn', { link = 'GitSignsAdd' })
hi('GitSignsAddInline', { link = 'GitSignsAdd' })
hi('GitSignsChange', { fg = palette.base0E, bg = palette.baseNN, attr = nil, sp = nil })
hi('GitSignsChangeLn', { link = 'GitSignsChange' })
hi('GitSignsChangeInline', { link = 'GitSignsChange' })
hi('GitSignsDelete', { fg = palette.base08, bg = palette.baseNN, attr = nil, sp = nil })
hi('GitSignsDeleteLn', { link = 'GitSignsDelete' })
hi('GitSignsDeleteInline', { link = 'GitSignsDelete' })
hi('GitSignsUntracked', { fg = palette.base0D, bg = palette.baseNN, attr = nil, sp = nil })
...
hi('TelescopeMultiSelection', { fg = nil, bg = palette.baseNN, attr = 'bold', sp = nil })
hi('TelescopeSelection', { fg = nil, bg = palette.baseNN, attr = 'bold', sp = nil })

-- Treesitter
hi('@keyword.return', { fg = palette.base08, bg = nil, attr = nil, sp = nil })
hi('@symbol', { fg = palette.base0E, bg = nil, attr = nil, sp = nil })
hi('@variable', { fg = palette.base05, bg = nil, attr = nil, sp = nil })
...
-- Semantic Tokens
hi('@lsp.type.variable', { fg = palette.base05, bg = nil, attr = nil, sp = nil })
hi('@lsp.mod.defaultLibrary', { link = 'Special' })
hi('@lsp.mod.deprecated', { fg = palette.base08, bg = nil, attr = nil, sp = nil })
